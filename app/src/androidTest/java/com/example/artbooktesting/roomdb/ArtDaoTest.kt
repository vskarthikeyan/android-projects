...
import com.example.artbooktesting.HiltTestRunner
...
class ArtDaoTest {
    ...
    fun insertArtTesting() = runBlockingTest{
        var exampleArt = Art("Mona Lisa", "Motta Hari", 1900, "double.test.com", 1)
        dao.insertArt(exampleArt)

        var list = dao.observeArts().getOrAwaitValueTest()
